...
from crowd_ppo.crowd_env_egobody_eval import CrowdEnv
from crowd_ppo.primitive_model import load_model
from crowd_ppo.ppo_policy import GAMMAPPOPolicy
from exp_GAMMAPrimitive.utils.environments import Egobody as SceneTrainGen
...
def main():
    test_envs = DummyCrowdVectorEnv([lambda: CrowdEnv(init_env), lambda: CrowdEnv(init_env2)])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--logdir", type=str, default="log/log_eval_egobody")
    parser.add_argument("--scene-name", type=str, default="cab_e")
