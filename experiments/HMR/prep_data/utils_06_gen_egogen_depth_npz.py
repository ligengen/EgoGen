...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(data_root, "smplx_spin_holo_depth_npz")):
        os.makedirs(os.path.join(data_root, "smplx_spin_holo_depth_npz"))

    np.savez(os.path.join(data_root, 'smplx_spin_holo_depth_npz', 'egocapture_train_smplx.npz'), **out_dict)
    print('npz saved.')
