...
def get_body_model(type, gender, batch_size,device='cpu'):
    ...
    '''
    body_model_path = 'data/smplx/models'
...
if __name__=='__main__':
    ...
    if N_MPS > 1:
        samp_smplx_path = 'data/samp/Canonicalized-MPx{:d}/data'.format(N_MPS)
    else:
        samp_smplx_path = 'data/samp/Canonicalized-MP/data'
